...
plt.plot(x,f1(x), color ="#33aee8", label = "f1(x)")
plt.plot(x,f2(x), color ="#0bae13", label = "f2(x)")
plt.plot(x, g1(x), color = "#cedc0e", label = "g1(x)")
plt.plot(x, g2(x), color = "#fe0505", label = "g2(x)")
